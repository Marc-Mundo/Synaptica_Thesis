...
This chapter describes the methods used in this research.\todo[inline,
    color=red!40]{Fix the references for the individual cells}
% New todo added here
...
in cooperation with Sean Gies is part of the /textit{Neuromics} software
package by Synaptica Ltd.

\section{Model implementation: cell parameters}
\begin{enumerate}
    \item \textbf{Basket Cells}: Modeled after Wang and Buzsáki (1996),
    ...
    \item \textbf{O-LM Cells}: Adapted from Saraga et al. (2003),
          ...
          \(\mu\text{A/cm}^2\).
    \item \textbf{Pyramidal Cells}: Based on Migliore et al. (2004),
