...
Add general text dominant frequencies.
...
Add text theta frequency for sodium and potassium.
\subsubsection{Gamma frequency}
Add text gamma frequency for sodium and potassium.

\subsection{Theta-gamma power}
Add general text theta-gamma power.
...
Add theta power results here for sodium and potassium.
\subsubsection{Gamma power}
Add gamma power results here for sodium and potassium.
\todo[inline]{add pictures of LFPs theta-gamma power shift, see ppt.}
\pagebreak
