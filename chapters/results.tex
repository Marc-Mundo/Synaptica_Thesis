...
When O-LM-pyramidal connectivity was decreased to a range of 20--10 \%, desynchronization was observed among basket cells.
Complete desynchronization was observed when the O-LM-pyramidal connectivity was reduced to 0 \%.
Pyramidal to O-LM connectivity was was unchanged, thus these cells showed sustained synchronous activity.

\todo[inline]{insert a picture of network scatterplot at 0 \% and 20 or 10 \% olmpyrweight}
...
\todo[inline]{explain PSD calculation for the theta and gamma power in the methods}.
...
\begin{figure}[!htb]
    \centering
    % First sub-figure
    \includegraphics[width=1.0\linewidth]{network_activity_0.80_0.80_1.00.png}
    \vspace{1em} % Space between the sub-figures

    % Second sub-figure
    \includegraphics[width=1.0\linewidth]{network_activity_0.80_1.20_1.00.png}
    \vspace{1em} % Space between the sub-figures

    % Third sub-figure
    \includegraphics[width=1.0\linewidth]{network_activity_1.00_1.00_1.00.png}
...
\begin{figure}[!htb] \ContinuedFloat% Continue the figure from the previous page
    \centering
    % Fourth sub-figure
    \includegraphics[width=1.0\linewidth]{network_activity_1.20_0.80_1.00.png}
    \vspace{1em} % Space between the sub-figures

    % Fifth sub-figure
    \includegraphics[width=1.0\linewidth]{network_activity_1.20_1.20_1.00.png}
