...
\usepackage{newunicodechar}  % Ensure this package is included to use \newunicodechar
...
% Page number on the right side of the footer (or center if preferred)
\fancyfoot[C]{\thepage} % Adjust to [C] if center alignment is preferred

% Ensuring no line appears above the header or footer
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}

% Redefining the plain page style to be consistent
\fancypagestyle{plain}{ 
  \fancyhf{} % Clear all header and footer fields
  \fancyfoot[C]{\thepage} % Maintain consistent page numbering
  \renewcommand{\headrulewidth}{0pt}
  \renewcommand{\footrulewidth}{0pt}
}

\begin{document}
\pagestyle{fancy} % Reinforce the page style
...
%\listoftodos% Remove this line when you're done with the document, or uncomment if used

\addcontentsline{toc}{chapter}{Copyright Statement}
\include{personalization/copyright}
\addcontentsline{toc}{chapter}{Abstract}
\include{chapters/abtract}
\addcontentsline{toc}{chapter}{Acknowledgements}
\include{personalization/thanks}
\include{personalization/quote}

\hypertarget{toc}{}% Set a hyper target for the Table of Contents
\tableofcontents
\listoffigures
\listoftables
