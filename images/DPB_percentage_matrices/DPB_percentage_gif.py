...
# Use the absolute path for the directory where the percentage plots are saved
plot_directory = (
    "/home/Marc/Marc_network_sims/imgs/Results_Feb16/DPB_percentage_matrices/"
)

# Updated glob pattern to match the new file naming convention for percentage
plot_files = sorted(
    glob.glob(plot_directory + "DPB_percentage_noise_*.png"),
...
if images:
    ...
    images[0].save(
        plot_directory + "DPB_percentage_animation.gif",
        save_all=True,
